  ...
  return (
    <section id="contact">
      <MDBContainer fluid className="px-5">
        <h1 className="font-weight-bold section-heading text-center mt-5 mb-3">
          Contact us
        </h1>
        <p className="section-description mb-5 mb-3 text-center">
          We look forward to hearing from you and discussing how we can assist
          you with your needs.
        </p>

        <MDBRow>
          <MDBCol lg="5" className="mb-4 mb-md-0 mb-5">
            <MDBCard>
              <MDBCardBody>
